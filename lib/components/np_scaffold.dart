...
import 'package:necessary_pink_demo/components/multi_floating_action_button.dart';
...
class NPScaffold extends StatefulWidget {
  /// Extras:
  ...
  static NPScaffoldState of(BuildContext context, {bool nullOk = false}) {
    final NPScaffoldState result =
        context.ancestorStateOfType(const TypeMatcher<NPScaffoldState>());
    return result;
  }

  @override
  NPScaffoldState createState() => NPScaffoldState();
}

class NPScaffoldState extends State<NPScaffold> {
  ...
  void refreshState() {
    var state = NPScaffold.of(context);
    if (state != null) {
      state.refreshState();
    } else {
  ...
  Widget _buildAppBar(BuildContext context) {
    NPScaffoldState state = NPScaffold.of(context);

    PreferredSizeWidget appbar;
    NPAppBar npAppBar = widget.appBar is NPAppBar ? widget.appBar : null;
